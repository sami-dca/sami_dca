...
class MainMenu(wx.Frame):
    def __init__(self, parent):
        ...
        info_sbSizer = wx.StaticBoxSizer(
            wx.StaticBox(self, wx.ID_ANY, "Info"), wx.VERTICAL
        )

        server_status_bSizer = wx.BoxSizer(wx.HORIZONTAL)

        self.server_status_info_staticText = wx.StaticText(
            info_sbSizer.GetStaticBox(),
            wx.ID_ANY,
            "Listening status: ",
            wx.DefaultPosition,
            wx.DefaultSize,
        ...
        self.server_status_info_staticText.SetForegroundColour(
            wx.SystemSettings.GetColour(wx.SYS_COLOUR_WINDOWTEXT)
        )
        self.server_status_info_staticText.SetBackgroundColour(
        ...
        self.server_status_staticText = wx.StaticText(
            info_sbSizer.GetStaticBox(),
            wx.ID_ANY,
            "Down",
            wx.DefaultPosition,
        ...
        self.server_status_staticText.SetFont(
            wx.Font(
        ...
        self.node_name_info_staticText = wx.StaticText(
            info_sbSizer.GetStaticBox(),
            wx.ID_ANY,
            "Your name : ",
            wx.DefaultPosition,
        ...
        self.node_name_staticText = wx.StaticText(
            info_sbSizer.GetStaticBox(),
            wx.ID_ANY,
            wx.EmptyString,
            wx.DefaultPosition,
        ...
        self.node_name_staticText.SetFont(
            wx.Font(
                wx.NORMAL_FONT.GetPointSize(),
                wx.FONTFAMILY_DEFAULT,
                wx.FONTSTYLE_NORMAL,
        ...
        rsa_keys_sbSizer = wx.StaticBoxSizer(
            wx.StaticBox(self, wx.ID_ANY, "RSA keys"), wx.VERTICAL
        )

        self.rsa_private_key_status_staticText = wx.StaticText(
            rsa_keys_sbSizer.GetStaticBox(),
            wx.ID_ANY,
            "RSA private key: ",
            wx.DefaultPosition,
            wx.DefaultSize,
        ...
        self.private_key_filePicker = wx.FilePickerCtrl(
            rsa_keys_sbSizer.GetStaticBox(),
            wx.ID_ANY,
            wx.EmptyString,
            "Select an RSA PrivateKey file",
            "*.pem",
            wx.DefaultPosition,
            wx.DefaultSize,
            wx.FLP_DEFAULT_STYLE,
        )
        self.private_key_filePicker.SetToolTip("Select an RSA private key file")

        rsa_bSizer.Add(self.private_key_filePicker, 1, wx.ALL | wx.EXPAND, 5)

        self.export_pubkey_button = wx.Button(
            rsa_keys_sbSizer.GetStaticBox(),
            wx.ID_ANY,
            "Export pubkey",
            wx.DefaultPosition,
        ...
        self.create_new_key_pair_button = wx.Button(
            rsa_keys_sbSizer.GetStaticBox(),
            wx.ID_ANY,
        ...
        self.create_new_key_pair_button.SetToolTip("Create a new pair of RSA keys")
        ...
        chat_sbSizer = wx.StaticBoxSizer(
            wx.StaticBox(self, wx.ID_ANY, "Chat"), wx.VERTICAL
        )

        self.show_conversations_Button = wx.Button(
            chat_sbSizer.GetStaticBox(),
            wx.ID_ANY,
            "Chat with other nodes",
            wx.DefaultPosition,
            wx.DefaultSize,
            0,
        )
        ...
        # Connect Events
        self.private_key_filePicker.Bind(
            wx.EVT_FILEPICKER_CHANGED, self.load_private_key
        )
        self.export_pubkey_button.Bind(wx.EVT_BUTTON, self.export_pubkey)
        self.create_new_key_pair_button.Bind(
            wx.EVT_BUTTON, self.open_pair_creation_window
        )
...
class CreateNewKeyPair(wx.Frame):
    def __init__(self, parent):
        ...
        self.pair_creation_info_1_staticText = wx.StaticText(
            pair_location_sbSizer.GetStaticBox(),
            wx.ID_ANY,
            "Note: as soon as you select a directory, the creation will launch.",
            wx.DefaultPosition,
            wx.DefaultSize,
            0,
        )
        ...
        self.key_pair_location_dirPicker = wx.DirPickerCtrl(
            ...
            wx.ID_ANY,
            wx.EmptyString,
            "Select a folder where the keys will be stored",
            wx.DefaultPosition,
            wx.DefaultSize,
            wx.DIRP_DEFAULT_STYLE,
        )
        pair_location_sbSizer.Add(
            self.key_pair_location_dirPicker, 0, wx.ALL | wx.EXPAND, 5
        )

        self.pair_creation_info_2_staticText = wx.StaticText(
            pair_location_sbSizer.GetStaticBox(),
            wx.ID_ANY,
            'File will be named "private_[ID].pem".',
            wx.DefaultPosition,
            wx.DefaultSize,
            0,
        )
        ...
        # Connect Events
        self.key_pair_location_dirPicker.Bind(
            wx.EVT_DIRPICKER_CHANGED, self.create_key_pair
        )
...
class ReceivedMessages(wx.Frame):
    def __init__(self, parent):
        ...
        self.filter_nodes_search_ctrl = wx.SearchCtrl(
            self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, 0
        )
        self.filter_nodes_search_ctrl.ShowSearchButton(True)
        self.filter_nodes_search_ctrl.ShowCancelButton(True)
        self.filter_nodes_search_ctrl.SetToolTip("Search for a node")

        self.received_messages_bSizer.Add(
            self.filter_nodes_search_ctrl, 0, wx.ALL | wx.EXPAND, 5
        )
        ...
        self.received_messages_bSizer.Add(
            self.chat_container_main_bSizer, 1, wx.EXPAND, 5
        )
...
class Conversations(wx.Frame):
    def __init__(self, parent):
        wx.Frame.__init__(
            ...
            parent,
            id=wx.ID_ANY,
            title="Conversation - node1",
            pos=wx.DefaultPosition,
            size=wx.Size(624, 320),
            style=wx.DEFAULT_FRAME_STYLE | wx.TAB_TRAVERSAL,
        )
        ...
        self.new_message_textCtrl = wx.TextCtrl(
            self,
            wx.ID_ANY,
            wx.EmptyString,
            wx.DefaultPosition,
        ...
        self.send_message_button = wx.Button(
            self, wx.ID_ANY, "Send", wx.DefaultPosition, wx.DefaultSize, wx.BU_EXACTFIT
        )
